...
//  Typing Tutor
//
//  Created by VSSKANAND on 22/02/15.
...
/* Functions for displaying typing tips */
void tips(void)
{
    clrscr();
    gotoxy(2,3);
    ...
    gotoxy(2,15);
    cout<<"4. Avoid looking at the keyboard while typing and try to keep your eyes on the ";
    gotoxy(5,16);
    cout<<"screen. ";
...
void practice(void)
{
    ...
    /* Function for taking a typing test */
    void test(void)
    {
        char ch1,ch2;
        int count,noc;
